...
let token=require('./tokenGenerator')
...
let tableName='New_chat';
const port = 8000;
const expiryDate=3600000000000000;// Expiration date for the session cookie
        ...
        if (err) throw err;
            ...
            con.query(query, [email, password], (err, result) => {
                ...
                if (result.length > 0) {
                    ...
                    res.cookie('loggedIn', true, { maxAge: expiryDate, httpOnly: false });
